    ...
    return (
        ...
        className='h-screen flex flex-col items-center justify-center gap-14 bg-light text-center'>
            ...
            transition={{duration: 0.6, delay: 0.4}}
             onSubmit={handleSearch} className='flex flex-col md:flex-row items-start md:items-center justify-between p-6 rounded-lg md:rounded-full w-full max-w-80 md:max-w-190 bg-white shadow-[0px_8px_20px_rgba(0,0,0,0.1)]'>
            ...
            src={assets.main_car} alt="car" className='max-h-64 px-7'/>
        </motion.div>
    )
}
